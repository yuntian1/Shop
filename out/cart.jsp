...
<%--		判断购物车是否有商品--%>
						...
						<tbody>
							...
							<c:forEach items="${cart.cartItems}" var="entry">
								<tr class="active">
									...
									<td>
										<a href="javascript:;" onclick="delProFormCart('${entry.value.product.pid}')" >删除</a>
									</td>
								</tr>
							</c:forEach>
		...
		<c:if test="${empty cart.cartItems}">
			<div style="height:600px">
                <div class="div">
                    <img alt="" src="${pageContext.request.contextPath}/images/cart-empty.png" height="400px" width="600px"/>
                </div>
                <div class="div">
<%--                    <p align="center" style="">购物车是空的快去添加吧</p>--%>
                    <h1 style="color: #5cb85c">购物车是空的快去添加吧</h1>
                </div>
			</div>
