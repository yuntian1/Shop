    ...
    <script type="text/javascript">
        $(function () {
            ...
            new PopupLayer({
                ...
                popupBlk: "#showDiv", //弹出那个div
                closeBtn: "#closeBtn",//关闭
                useOverlay: true
            });
        ...
        function findOrderInfoByOid(oid) {
            ...
            $.post(
                ...
                function (data) {
                    ...
                    var content = "<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th>" +
                        "<th width='15%'>数量</th><th width='20%'>小计</th></tr>";
                    for (var i = 0; i < data.length; i++) {
                        content+= "<tr style='text-align: center;'>" +
                            ...
                            "<td>"+data[i].count+"</td>" +
                            " <td><span class='subtotal'>￥"+data[i].subtotal+"</span>" +
                            "</td>" +
                            "</tr>";
                    }
                        $("#showDivTab").append(content);
                        $("#shodDivOid").append(oid);
                },
                "json"
            );
