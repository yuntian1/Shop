        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#is_hot option[value='${product.is_hot}']").prop("selected",true);
					...
					// });
				function resitting() {
					var isResitting = confirm("你确定要重置吗");
					if(isResitting){
						location.href="${pageContext.request.contextPath}/adminUpdateProduct";
					}
				}
			});
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="pname" value="${product.pname}" id="userAction_save_do_logonName1" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						是否热门：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="market_price" value="${product.market_price}" id="userAction_save_do_logonName2" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商城价格：
					</td>
...
<%--						<p>图片</p>--%>
						<img src="${pageContext.request.contextPath}/${product.pimage}" width="100" height="100" class="image" id="image">
<%--						<input type="file" class="file" id="image-input" name="pimage" />--%>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<button type="submit" id="userAction_save_do_submit" value="确定" class="button_ok" onClick="submitAction();return false;">
							&#30830;&#23450;
						</button>

						<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
						<button type="reset" value="重置" class="button_cancel" onclick="resetting()">&#37325;&#32622;</button>
