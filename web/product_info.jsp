...
.carousel-inner .item img {
    ...
    <script type="text/javascript">
        function addCart(){
            ...
            location.href="${pageContext.request.contextPath}/product?method=addToCart&pid=${product.pid}&buyNum="+buyNum;
        }
    </script>
</head>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product.shop_price}/份</strong> 参 考 价：
					...
					<div>
						<a href="${pageContext.request.contextPath}/product?method=productList&cid=${cid}&currentPage=${currentPage}">返回上个列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
