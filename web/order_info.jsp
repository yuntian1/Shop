...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderform" class="form-horizontal" style="margin-top: 5px; margin-left: 150px;" action="${pageContext.request.contextPath}/product" method="post">
<%--				method的方法通过表单提交--%>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="confirmpwd" name="telephone" value="${user.telephone}">
					</div>
				</div>
